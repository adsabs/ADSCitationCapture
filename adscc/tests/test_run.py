...
class TestWorkers(unittest.TestCase):
    ...
    def test_run(self):
        ...
        expected_citation_change_from_first_file = [
                ...
                '\n\x131910GeoRu...1....1D\x12\x131868AmJSA..46..240B"\x1910.2475/ajs.s2-46.137.2400\x02',
                '\n\x131910GeoRu...1...36M\x12\x131898hra..conf...75V"\x1610.2475/ajs.s4-6.31.750\x02',
                ...
                '\n\x132013arXiv1310.5912S\x12\x132012ascl.soft.8004S\x18\x01"\x0eascl:1208.80040\x02',
                '\n\x132015ApJ...815L..10L\x12\x132015ascl.soft...10J\x18\x01"\rascl:1510.0100\x02',
